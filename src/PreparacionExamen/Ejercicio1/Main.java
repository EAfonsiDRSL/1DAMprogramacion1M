...
public class Main {
    public static void main(String[] args) throws EdadIncorrecta, SexoIncorrecto {
        ...
        Persona persona1 = new Persona(nombre,edad,23456543,sexo,peso,altura);

        System.out.println("Introduzca el nombre de la segunda persona");
        nombre = sc.next();
        System.out.println("Introduzca la edad de "+nombre);
        edad = sc.nextInt();
        Persona persona2 = new Persona(nombre, 12,23456543,"m",78.4,1.87);
        ...
        for (int i = 0 ; i<lista_personas.length ; i++){
            System.out.println("El peso de "+lista_personas[i].getNombre()+" es "+lista_personas[i].calcularIMC());
